...
const options = {
	...
	userName:  process.env.MASTERUSER || globalConfig.masterUser,
	pwd: process.env.MASTERPWD || globalConfig.masterPwd,
	agentName
}
...
client.on('masterError', function(msg) {
	console.log('masterError:', msg.data)
	process.exit(0)
})
...
module.exports = {
	...
	sendTo: function(dest, topic, data) {
		return client.sendTo(dest, topic, data)
	},
